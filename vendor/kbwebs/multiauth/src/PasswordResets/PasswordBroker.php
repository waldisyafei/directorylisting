...
class PasswordBroker implements PasswordBrokerContract
{
     ...
     * @var \Kbwebs\MultiAuth\PasswordResets\TokenRepositoryInterface
     */
    protected $tokens;
     ...
     * @param  string                                                           $type
     * @param  \Kbwebs\MultiAuth\PasswordResets\TokenRepositoryInterface        $tokens
     * @param  \Illuminate\Contracts\Auth\UserProvider                          $users
     * @param  \Illuminate\Contracts\Mail\Mailer                                $mailer
     * @param  string                                                           $emailView
     * @return void
     */
    public function __construct($type, TokenRepositoryInterface $tokens, UserProvider $users, MailerContract $mailer, $emailView)
    {
        $this->type         = $type;
        $this->users 		= $users;
        $this->mailer 		= $mailer;
     ...
     * @param  array  $credentials
     * @return \Kbwebs\MultiAuth\PasswordResets\CanResetPassword
     */
    ...
    public function getUser(array $credentials)
    {
        ...
        if ($user && !$user instanceof CanResetPasswordContract) {
            throw new UnexpectedValueException(ucfirst($this->type).' must implement CanResetPassword interface.');
        }
        return $user;
    }
     ...
     * @return \Kbwebs\MultiAuth\PasswordResets\TokenRepositoryInterface
     */
