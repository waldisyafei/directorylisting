		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel panel-midnightblue" data-widget='{"draggable": "false"}'>
					...
					<form class="form-horizontal row-border" method="post" action="{{ url('nonsubs/edit_info', Auth::nonsubs()->get()->id) }}">
						...
						<div class="panel-body" style="padding: 40px 16px;">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="name" class="form-control" id="fullname" placeholder="Full Name" value="{{ $customer->nonsub_name }}">
								</div>
							</div>
							<div class="form-group">
