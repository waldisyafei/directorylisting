			...
			<div class="col-md-12">
				<div class="panel panel-blue">
					...
					<div class="panel-body">
						...
						<form action="{{ url('nonsubs/ads/buy') }}" method="post" id="buy-ads-wizard" class="form-horizontal">
						...
						<!--	</fieldset>-->
							<input type="submit" class="finish btn-success btn right" value="Submit" />
						</form>
					</div>
					<!-- ./End panel body -->
				</div>
