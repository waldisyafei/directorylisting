...
<!-- 
			...
			<?php// endif ?> -->
								...
								<div class="flexslider">
									<ul class="slides">
										...
										@foreach ($ads as $ad)
											...
											$img_entry = str_replace($filename, 'thumb-'.$filename, $assets[0]);
											?>
											<li><a href="<?php echo url('ads' .'/'.  $ad->ad_id) ?>" class="topra top-r1"><img style="height: 94px; border-radius: 5px;" src="{{ url($img_entry) }}" alt=""></a></li>
											<?php $c++; ?>
										@endforeach
									</ul>
								</div>
						...
						<div class="col-md-4">
							<div class="header-top-r">
								<?php $ads = getActiveAdsDsc(true);// dd($ads); ?>
								<?php if (count($ads) > 0): ?>
								<div class="flexslider">
									<ul class="slides">
										<?php $c = 0; ?>
