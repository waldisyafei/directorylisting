...
class AdsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('customer.pages.advertising.list', ['ads' => $ads]);
    }
    ...
    {
        return view('customer.pages.advertising.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($ad->save()) {
            ...
            create_billing($ad->customer_id, $ad->id, 'ad', $ad->package->price);
    ...
    public function edit($id)
    {
        ...
        return view('customer.pages.advertising.edit', ['ad' => $ad]);
    }
    ...
    {
        return view('customer.pages.advertising.buy-ads');
    }

    public function buy()
    {
        return view('customer.pages.advertising.buy');
    }
